...
internal sealed class FunctionFactory : IEnumerable<string>
{
    ...
    public FunctionFactory(ITimePointProvider timePointProvider)
    {
        ...
        _oneParamFunctions = new(StringComparer.InvariantCultureIgnoreCase)
        {
            ...
            { nameof(TypeFunctions.Sinh), TypeFunctions.Sinh },
            { nameof(TypeFunctions.Cosh), TypeFunctions.Cosh },
            { nameof(TypeFunctions.Tanh), TypeFunctions.Tanh },
            { nameof(TypeFunctions.ArcSinh), TypeFunctions.ArcSinh },
            { nameof(TypeFunctions.ArcCosh), TypeFunctions.ArcCosh },
            { nameof(TypeFunctions.ArcTanh), TypeFunctions.ArcTanh },
            ...
            { nameof(TypeFunctions.ToRoman), TypeFunctions.ToRoman },
            { nameof(TypeFunctions.FromRoman), TypeFunctions.FromRoman }
        };
        _twoParamFunctions = new(StringComparer.InvariantCultureIgnoreCase)
        {
            ...
            { nameof(TypeFunctions.Round), TypeFunctions.Round }
        };
    ...
    public IExpression Create(string name, IExpression[] parameters)
    {
        ...
        return name switch
        {
            ...
            "sinh" => new SinhExpression(parameters[0]),
            "cos" => new CosExpression(parameters[0]),
            "arccos" => new ArcCosExpression(parameters[0]),
            "cosh" => new CoshExpression(parameters[0]),
            "tan" => new TanExpression(parameters[0]),
            "tanh" => new TanhExpression(parameters[0]),
